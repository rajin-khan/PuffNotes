  ...
  const features = [
    {
      ...
      description: "Stop fighting with formatting. Write naturally, hit beautify, and watch AI structure your thoughts without losing your voice.",
      video: "/videos/2.mp4",
      variant: "cream",
    ...
    },
    {
      ...
      description: "When you need deep focus, everything else fades away. Just you, your words, and a calming space to think.",
      video: "/videos/5.mp4",
      variant: "amber",
