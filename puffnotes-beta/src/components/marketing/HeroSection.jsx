        ...
        <div className="max-w-7xl mx-auto px-6 w-full">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
              ...
              <div className="space-y-8">
                ...
                >
                  <h2 className="font-serif text-2xl lg:text-3xl font-medium text-[#FFF8F0] leading-relaxed drop-shadow-xl">
                    Turn brain dumps into beautiful notes
                  </h2>
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="warm-card-cream warm-shadow-premium p-8 bg-warm-white/98 backdrop-blur-sm rounded-3xl border border-warm-border/30">
                <div className="bg-warm-white rounded-2xl p-6 min-h-[320px] warm-border-light shadow-inner">
                ...
                {!isTyping && (
                  ...
                  >
                    <div className="bg-[#FFF8F0]/95 backdrop-blur-sm p-3 rounded-full border-2 border-[#FFF8F0] shadow-xl ring-2 ring-[#FFF8F0]/20">
                      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" className="text-[#5C4A40]">
