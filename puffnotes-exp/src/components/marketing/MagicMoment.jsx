      ...
      <div className="text-center space-y-16">
        ...
        >
          ...
          <p className="text-lg font-mono max-w-3xl mx-auto leading-relaxed text-[#362112]/80">
            Your scattered thoughts, rushed meeting notes, or late-night ideas — instantly transformed into structured, readable content. No editing required. No formatting headaches. Just pure magic.
          </p>
        </motion.div>
